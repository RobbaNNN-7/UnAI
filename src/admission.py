...
## TO CREATE:
# USER INPUPTS: UNIVERSITY NAME:
# OUTPUT:      PRO's CON's ADMISSION CRITERIA TEST_NAME DATE 

## First Prompt , Inputting University Name

system = "You are admission portal Chat Bot Which Answers Student's Queries"
